...
$rc=$stmt->bind_param('ssssisi',$fname,$mname,$lname,$gender,$contact,$udate,$aid);
$stmt->execute();
if($rc)
{
...
<div class="col-sm-8">
<input type="text" name="regno" id="regno"  class="form-control" required="required" value="" >
</div>
</div> 
...
<div class="col-sm-8">
<input type="text" name="fname" id="firstName"  class="form-control" value="<?php echo $row->firstName;?>"   required="required" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="middleName" id="mname"  class="form-control" value="<?php echo $row->middleName;?>"  >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="lastName" id="lname"  class="form-control" value="<?php echo $row->lastName;?>" required="required">
</div>
</div>
