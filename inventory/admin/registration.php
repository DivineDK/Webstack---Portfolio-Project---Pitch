...
$password=$_POST['password'];
	...
	$sql = "insert into userregistration (firstName,middleName,lastName,gender,contactNo,email,password)
	values ('$fname','$mname', '$lname','$gender', '$contactno','$emailid','$password');";
...
{
alert("Check and Re-Type Password, Fields do not match  !!");
...
<div class="col-sm-8">
<input type="text" name="contact" id="contactNo"  class="form-control" minlength="10" maxlength="10" pattern="[0-9]*" tittle="Please enter only digits" required="required">
</div>
</div>
